...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String image_url = "http://funsproject.com/chindb/imageUpload/profile/"+phone+".jpg";
    ...
    void loadUserProfile() {
        class LoadUserProfile extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest("http://funsproject.com/chindb/load_user.php", hashMap);
                return s;
            }
    ...
    void updateProfile(final String newemail, final String newname, final String oldpass, final String newpass) {
        class UpdateProfile extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("http://funsproject.com/chindb/php/update_profile.php", hashMap);
                return s;
            }
